...
namespace MediaPortal.UI.SkinEngine.Controls.Visuals
{
  ...
  /// </para>
  /// <para>
  /// The "outer part" of the virtual keyboard can be styled like other controls. The "inner part", which contains the keys, cannot be styled.
  ...
  /// which is provided by the <c>VirtualKeyboardLayout</c> control template.
  /// </para>
  /// <para>
